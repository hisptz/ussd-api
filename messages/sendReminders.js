...
const valuesUrl = `${appConfig.url}/api/dataValueSets.json?dataSet=t6N3L1IElxb&period=${period}&orgUnit=`;
//const valuesUrl = `${authLink}dataValueSets.json?dataSet=t6N3L1IElxb&period=${period}&orgUnit=`;
const orgsUrl = `${appConfig.url}/api/organisationUnits.json?filter=level:eq:6&paging=false&fields=id,name,code,phoneNumber,attributeValues,parent[name,leve,parent[name,level,parent[name,level]]]`;
